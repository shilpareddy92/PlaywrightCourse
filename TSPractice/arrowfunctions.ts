...
let withParameters = (a: number, b: number) => console.log(a + b);
withParameters(2, 3);

let withReturn = (a: number, b: number): number => {
  return a + b; // curly braces is mandatory
};

console.log(withReturn(3, 5));

let addition = (a: number, b: number): number => a + b; // curly braces and no return values
